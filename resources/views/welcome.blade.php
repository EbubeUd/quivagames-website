...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <meta property="og:site_name" content="Quiva Games" /><!--website name-->
        <meta property="og:site" content="quiva.games" /> <!--website link-->
        <meta property="og:title" content="Quiva Games"/> <!--Post title-->
        <meta property="og:description" content="Quiva Games is a Computer and Video Game publisher, With a major focus of integrating Crypto currencies and Blockchain assets into modern day genre of games. At Quiva, we believe in adding so much value into games as well as financial rewards to its players through our well examined system of Game Economics." /> <!--Post description-->
        <meta property="og:image" content="" /><!-- Image link (jpg only)-->
        <meta property="og:url" content="quiva.games" /> <!--where do you want your post to link to-->
            ...
            <div id="hero-slider" class="carousel slide" data-ride="carousel">
                @if ($page_data['carouselitem'])
                    <ol class="carousel-indicators">
                        @for ($i = 0; $i < count($page_data['carouselitem']); $i++)
                            <li data-target="#hero-slider" data-slide-to="{{$i}}" class="{{ $i == 0 ? 'active' : ''}}"></li>
                        @endfor
                    </ol>
        ...
        <div class="container">
            ...
            <div id="about" class="large-margin">
                ...
                <div class="row heading tiny-margin">
                    <div class="col-md-auto">
                        <h1 class="animation-element slide-down"><?php echo setting('site.about-us-title'); ?></h1>
                    </div>
                    <div class="col">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                @if(!isset($item['message']) || empty($item['message']))
                                    <p class="small-margin"><?php echo setting('site.about-us-message'); ?></p>
                                @endif
                                @isset($item['message'])
                                    <p class="small-margin"><?php echo $item['message']; ?></p>
                                @endisset
            ...
            <div id="games" class="large-margin">
                ...
                <div class="row ">
                    ...
                    <p><?php echo setting('site.our-games-message') ?></p>
                    </div>
                </div>
                                ...
                                @if ($item_value['display_mode'] == 'image')
                                    ...
                                    <div class="row game-card">
                                            ...
                                            @if(isset($item_value['image_small_url']) && isset($item_value['image_big_url']))
                                                <a href="{{ $item_value['image_big_url'] }}" data-lightbox="screenshots_dark">
                                                    ...
                                                    <picture>
                                                        ...
                                                        <img src="images/placeholder.jpg" data-src="{{ $item_value['image_small_url'] }}" class="img-fluid b-lazy" alt="aurora image">
                                                    </picture>
                                                </a>
                                            @endif
                                        ...
                                        <div class="col-lg-12 col-xl-7 game-card-right">
                                            ...
                                            {{--  <p class="game-description">{{ $item_value['description'] }}<span class="expand colored strong" data-toggle="modal" data-target="#mobile-game{{$item_key}}"> Read More</span></p>  --}}
                                            <p class="game-description">{{ $item_value['description'] }} <a target="_blank" href="<?php echo $item_value['mobile_game_website']; ?>" style="text-decoration:none;"><span class="expand colored strong">Read More</span></a></p>
                                            ...
                                            @isset($item_value['mobile_get_for_android'])
                                                <a href="{{ $item_value['mobile_get_for_android'] }}" class="button-store">
                                                    ...
                                                    <p>
                                                         ...
                                                         @endif
                                                         <br>
                                                    <span class="strong">Google Play</span></p>
                                                </a>
                                            @endisset
                                            @isset($item_value['mobile_get_for_apple'])
                                                <a href="{{ $item_value['mobile_get_for_android'] }}" class="button-store">
                                                    ...
                                                    <p>
                                                         ...
                                                         Coming Soon on
                                                         @endif
                                                         <br><span class="strong">Apple Store</span></p>
                                                </a>
                                            @endisset
                                            @isset( $item_value['mobile_rating_number'] )
                                                <div class="rating">
                                                    ...
                                                    <ul>
                                                        @for ($i = 0; $i < 5; $i++)
                                                            @if ($i < $item_value['mobile_rating_star'])
                                        ...
                                        @isset($item_value['mobile_game_detail'])
                                            @if (is_array($item_value['mobile_game_detail']) && count($item_value['mobile_game_detail'])>=1)
                                                <div class="modal fade game-modal" id="mobile-game{{$item_key}}" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        ...
                                                        <div class="modal-body">
                                                            @foreach ($item_value['mobile_game_detail'] as $item)
                                                                @if ($item['video_url'])
                                                                    <iframe class="modal-vid" src="{{ $item['video_url'] }}" allowfullscreen></iframe>
                                                                @endif
                                                                @if ($item['title'])
                                    ...
                                    <div class="row game-card">
                                        <div class="col-lg-12 col-xl-5 game-card-left">
                                            @isset($item_value['image_small_url'])
                                                <a href="#" class="js-video-button" data-video-id='{{ $item_value['youtube_video_id'] }}' data-channel="youtube"> <!-- Video link goes here -->
                                                    <div class="overlay">
                                                        <i class="fa fa-play fa-3x"></i>
                                                    </div>
                                                    <img src="images/placeholder.jpg" data-src="{{ $item_value['image_small_url'] }}" class="img-fluid b-lazy" alt="video-thumbnail"> <!-- Video Thumbnail Img -->
                                                </a>
                                            @endisset
                                        </div>
                                        <div class="col-lg-12 col-xl-7 game-card-right">
                                            ...
                                            <p class="tags"><span class="subtle">{{ $item_value['genre'] }}</span> </p>
                                            {{--  <p class="game-description">{{ $item_value['description'] }} <span class="expand colored strong" data-toggle="modal" data-target="#mobile-game{{$item_key}}"> Read More</span></p>  --}}
                                            <p class="game-description">{{ $item_value['description'] }} <a href="<?php echo $item_value['mobile_game_website']; ?>" style="text-decoration:none;"><span class="expand colored strong">Read More</span></a></p>
                                            @isset($item_value['mobile_get_for_android'])
                                                <a href="{{ $item_value['mobile_get_for_android'] }}" class="button-store">
                                                    <i class="fa fa-android fa-2x"></i>
                                ...
                                @if ($item_value['display_mode'] == 'image')
                                    ...
                                    <div class="row game-card">
                                        ...
                                        <div class="col-lg-12 col-xl-7 game-card-right">
                                            <h2 class="short-hr-left">{{ $item_value['name'] }}</h2>
                                            <p class="tags"><span class="subtle">{{ $item_value['genre'] }}</span></p>
                                            {{--  <p class="game-description">{{ $item_value['description'] }}<span class="expand colored strong" data-toggle="modal" data-target="#pc-game{{$item_key}}"> Read More</span></p>  --}}
                                            <p class="game-description">{{ $item_value['description'] }} <a href="<?php echo $item_value['pc_game_website']; ?>" style="text-decoration:none;"><span class="expand colored strong">Read More</span></a></p>
                                             @isset($item_value['pc_get_game_from_name'])
                                                <div class="steam-btn">
                                                    <a href="{{ $item_value['pc_get_game_from_url']  }}">
                                                        <i class="fa fa-gamepad fa-3x"></i>
                                                        <p>GET IT ON <br><span class="spaced">{{ $item_value['pc_get_game_from_name']  }}</span></p>
                                                    </a>
                                                </div>
                                            @endisset
                                            <div class="reviews">
                                        ...
                                        @isset($item_value['pc_game_detail'])
                                            @if (is_array($item_value['pc_game_detail']) && count($item_value['pc_game_detail'])>=1)
                                                <div class="modal fade game-modal" id="pc-game{{$item_key}}" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h1 class="modal-title" id="">{{ $item_value['name'] }}</h1>
            ...
            <div id="contact" class="large-margin">
                ...
                <div class="">
                    <div class="row small-margin">
                        <div class="col-md-11">
                            <p><?php echo setting('site.get-in-touch-message'); ?></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <form id="contactForm" data-toggle="validator" method="post" action="/contactus">
                                ...
                                <div class="form-group">
                                    <!-- Name Field -->
                                    <input type="text" name="name" id="name" placeholder="Name*" required size="35" data-error="Name is required">
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group">
                                    <!-- Email Field -->
                                    <input type="email" name="email" id="email" placeholder="Email*" required size="35" data-error="Email is required">
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group">
                                    <!-- Message Field -->
        ...
        <footer id="main-footer">
            <div id="footer"> 
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <p id="copyright">&copy; Quiva Games <span id="year"> </span></p><!-- Copyright Text -->
                          
                            <ul class="social-links"> <!-- Social Media Icons -->
                                <li><a target="_blank" href="{{setting('site.facebook')}}"><i class="fa fa-facebook fa-lg icon-social"></i></a></li>
                                <li><a target="_blank" href="{{setting('site.twitter')}}"><i class="fa fa-twitter  fa-lg icon-social"></i></a></li>
                                <li><a target="_blank" href="{{setting('site.google-plus')}}"><i class="fa fa-google-plus fa-lg icon-social"></i></a></li>
                                <li><a target="_blank" href="{{setting('site.linkedin')}}"><i class="fa fa-linkedin fa-lg icon-social"></i></a>
                                <li><a target="_blank" href="{{setting('site.pinterest')}}"><i class="fa fa-pinterest fa-lg icon-social"></i></a>
                                <li><a target="_blank" href="{{setting('site.instagram')}}"><i class="fa fa-instagram fa-lg icon-social"></i></a>
                            </ul>
                        </div>
                    </div>
                </div><!-- Container End -->
