        ...
        <div id="games" class="large-margin">
            ...
            <div class="games-portfoli">
                ...
                <div id="team" class="large-margin">
                    ...
                    <div class="row heading tiny-margin">
                        <div class="col-md-auto">
                            <h1 class="animation-element slide-down">CAREER <span class="colored"></span></h1>
                        </div>
                        <div class="col">
                            <hr class="animation-element extend">
                        </div>
                    ...
                    <div class="row medium-margin">
                        ...
                        <div id="full-row" class="row text-center">
                            <img src="images/Internship-design.jpg" style="max-width:100%" />
                        </div>
                        <div class="col-md-12 text-center">
                            <h1 class="text-center" style="margin-top: 20px">INTERNSHIP</h1>
                        </div>
                        <div class="col-md-12 tiny-margin text-center">
                            <div class="col-md-12 tiny-margin text-center">
                                This is your opportunity to work closely, and learn from professionals in the field. Its
                                the shortest route to securing a full-time position
                            </div>
                            <div class="col-md-12 text-center">
                                <h1 class="text-center" style="margin-top: 20px">ROLES</h1>
                            </div>
                            <br />
                            <div id="full-row" class="row">
                                <div class="col-md-4 text-left">
                                    <p style="margin-top: 20px; font-family:  Chekharda-BoldItalic; font-size: 1.7rem;">
                                        Game Programming
                                    </p>
                                </div>
                                <div class="col-md-4">
                                    <br>
                                    <hr style="margin-left: 20px;" class="animation-element extend">
                                </div>
                                <div class="col-md-4" style="text-align: left"> <button type="submit"
                                        class="button-disabled"
                                        style="margin-right: 0px !important; padding: 10px 30px; font-size: 1.5rem; width: 40%; font-weight: bold; cursor: not-allowed;">FULL</button>
                                </div>
                            </div>
                            ...
                            <div id="full-row" class="row">
                                ...
                                <div class="col-md-4" style="text-align: left"> <button type="submit" class="button"
                                        style="margin-right: 0px !important; padding: 10px 30px; font-size: 1.5rem; width: 40%; font-weight: bold"
                                        data-toggle="modal" data-target="#careerDescriptionModal-art">APPLY</button>
                                </div>
                            </div>
                            <div id="full-row" class="row">
                                <div class="col-md-4 text-left">
                                ...
                                <div class="col-md-4" style="text-align: right"> <button type="submit" class="button"
                                        style="margin-right: 0px !important; padding: 10px 30px; font-size: 1.5rem; width: 40%; font-weight: bold"
                                        data-toggle="modal" data-target="#careerDescriptionModal">APPLY</button>
                                </div>
                            </div>

                        </div>
                    </div>
                    <div id="careerDescriptionModal" class="modal fade" role="dialog" aria-labelledby="gridModalLabel"
                        style="display: none" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" style="pointer-events: all">
                            <div class="text-center" style="background-color: rgb(45, 45, 45); padding: 20px">
                                <span class="font-snapHand text-center"
                                    style="fontSize: 2rem; color: #9fa7ab; font-family: bebas; font-size: 2rem; color: white">DESCRIPTION</span>
                                <br />
                                <p>Learn to make great UI/UX design for games.</p>
                                <hr />
                                <span class="font-snapHand text-center"
                                    style="font-size: 2rem ,
                                                color: #9fa7ab; margin: auto; float: center; font-family: bebas; font-size: 2rem;color: white">REQUIREMENTS</span>
                                <br />
                                <p>A Laptop with at least 2gb RAM and a 3-button mouse.<br />
                                    If you're currently in school, you have to be in final year.<br />
                                    Capability to work independently with minimum supervision.<br />
                                    Must have some prior knowledge of a design software.</p>
                                <br />
                                <hr />
                                <button type="submit" class="button" id="proceedBtn">Proceed</button>
                            </div>
                    ...
                    <div id="careerDescriptionModal-art" class="modal fade" role="dialog"
                        aria-labelledby="gridModalLabel" style="display: none; " aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" style="pointer-events: all">
                            <div class="text-center" style="background-color: rgb(45, 45, 45); padding: 20px">
                                <span class="font-snapHand text-center"
                                    style="fontSize: 2rem; color: #9fa7ab; font-family: bebas; font-size: 2rem; color: white">APPLY
                                    AT LIQAIR</span>
                                <p>we work closely with liqair studios for our art and animation. click "Proceed" to
                                    apply on their website.</p>
                                <hr />
                                <button type="submit" class="button" id="artProceedBtn">Proceed</button>
                            </div>
